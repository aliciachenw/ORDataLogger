...
def test_tracking(ndi_filename, spraytrack_filename, R, t):
    # read file
    _, ndi_tracking = read_csv(ndi_filename)
    _, spraytrack_tracking = read_csv(spraytrack_filename)
...
if __name__ == '__main__':
    R, t = get_calib("ndi_tracker_calib.csv", "sprytrack_calib.csv")

    test_tracking("ndi_tracker_test.csv", "sprytrack_test.csv", R, t)
